...
async function cadastrarLivros(livros) {
    ...
    try {
        ...
        const sqlInserirLivros = `INSERT INTO livros(isbn, nome, autor_id, editora, ano_publi, status) 
                                 VALUES($1, $2, $3, $4, $5, $6) RETURNING *`
        const valuesBook = [livros.isbn, livros.nome, resAutores.rows[0].autor_id, livros.editora, livros.ano_publi, "disponível"]
